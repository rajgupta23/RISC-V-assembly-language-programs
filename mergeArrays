#Raj
#2020CSB1116
#Merging elements of two sorted arrays stored at whose starting addresses are given in registers x11 and x12(ie, self assigned)
#final sorted array will be stored at 0x10001000 in memory
